...
public class AccountTransaction {
	...
	public String toString() {
		return "AccountTransaction{" + "id=" + id + ", accountReference=" + accountReference + ", valuta=" + valuta
				+ ", bdate=" + bdate + ", value=" + value + ", isStorno=" + isStorno + ", saldo=" + saldo
				+ ", customerref='" + customerref + '\'' + ", instref='" + instref + '\'' + ", charge_value="
				+ charge_value + ", gvcode='" + gvcode + '\'' + ", additional='" + additional + '\'' + ", text='" + text
				+ '\'' + ", primanota='" + primanota + '\'' + ", usage='" + usage + '\'' + ", addkey='" + addkey + '\''
				+ ", isSepa=" + isSepa + '}';
	}
