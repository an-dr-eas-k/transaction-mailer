...
public class AccountTransactionDE {
   ...
   * <code>null</code>).
   * Das ist genau dann der Fall, wenn der Wert von <code>gvcode</code> gleich
   * <code>999</code> ist.
   * </p>
   * <p>
   * Wenn die Zusatzinformationen aber ausgewertet werden können (und
   * <code>gvcode!=999</code>),
   * so ist dieser String <code>null</code>, und die Felder <code>text</code>,
   * <code>primanota</code>,
   * <code>usage</code>, <code>other</code> und <code>addkey</code>
   * enthalten die entsprechenden Werte (siehe auch <code>gvcode</code>)
   * </p>
   */
