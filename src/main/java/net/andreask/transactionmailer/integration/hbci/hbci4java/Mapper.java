...
public class Mapper {
  ...
  public static AccountTransaction map(GVRKUms.UmsLine umsLine) {
    ...
    return new AccountTransaction()
        ...
        .setSaldo(umsLine.saldo != null && umsLine.saldo.value != null ? umsLine.saldo.value.getLongValue() : -1)
        .setText(umsLine.text)
        .setUsage(umsLine.usage != null && !umsLine.usage.isEmpty()
            ? umsLine.usage.stream().reduce(String::concat).get() : "")
